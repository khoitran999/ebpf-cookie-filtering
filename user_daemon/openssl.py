...
#define MAX_BUF_SIZE __MAX_BUF_SIZE__ //replaced by user space
...
struct probe_SSL_data_t {
        ...
        u32 uid;
        u32 len;
        int buf_filled; //0 for not filled, 1 for filled
        int rw; // 0 for read 1 for write
        char comm[TASK_COMM_LEN]; //name of the process
        u8 buf[MAX_BUF_SIZE]; //buffer to store copy of data
};

//size_t is the data type for size of an object
//calculate the byte offset of `buf` field relative to other fields before it
